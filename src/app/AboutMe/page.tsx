  ...
  const projects = [
    {
      id: 1,
      title: "LinkedIn",
      description: "Click here to visit my LinkedIn profile.",
      logo: <FaLinkedin />,
    ...
    },
    {
      id: 2,
      title: "GitHub",
      description: "Click here to visit my GitHub profile.",
      logo: <FaSquareGithub />,
    ...
    },
    {
      id: 3,
      title: "Facebook",
      description: "Click here to visit my Facebook profile.",
